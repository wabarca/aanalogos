...
# ==============================================================================
    ...
    if res_ejemplo.es_valido:
        ...
        st.markdown(
            ...
            f"> • **Bandas verdes verticales y etiquetas superiores verticales (90°) ({len(anios_analogos_ej)} años análogos):** Identifican con precisión los años candidatos que satisfacen **ambos criterios simultáneamente** ($r > {r_amo_th:.2f} \\land \\text{{MAD}} < {mad_amo_th:.2f}\\ ^\\circ\\text{{C}}$): **{str_anios_analogos}**.  \n"
