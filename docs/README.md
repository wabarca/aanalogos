...
* [**Fichas Técnicas de Índices Climáticos**](indices.md): Catálogo detallado de las 21 oscilaciones climáticas (definición física, cobertura histórica, dominios geográficos, períodos base climatológicos, tipología de variables y fuentes oficiales).
* [**Referencias Bibliográficas y Atribución**](referencias.md): 21 publicaciones científicas primarias con DOIs verificados, fuentes operacionales de datos y sección oficial de antecedentes y autoría.
