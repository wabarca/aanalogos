...
class TestVariableAuditAndEnso(unittest.TestCase):
    ...
    def test_expected_sources_urls(self):
        ...
        expected_urls = {
            ...
            "AtlTROP": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices",
            "SAtl": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices",
            "NAtl": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices",
