...
FUENTES_DATOS = {
    ...
    "AtlTROP": {"url": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices", "txt": "dataSSTOI.txt", "csv": "dataAtlTROP.csv"},
    "SAtl": {"url": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices", "txt": "dataSSTOI.txt", "csv": "dataSAtl.csv"},
    "NAtl": {"url": "https://www.cpc.ncep.noaa.gov/data/indices/sstoi.atl.indices", "txt": "dataSSTOI.txt", "csv": "dataNAtl.csv"},
